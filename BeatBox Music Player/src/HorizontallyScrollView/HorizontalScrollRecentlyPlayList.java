package HorizontallyScrollView;
...
public class HorizontalScrollRecentlyPlayList {

    static ScrollPane scrollPane;
    static ListView<PlayListWidget> listView;
    
    private static ObservableList<PlayListWidget> recentlyPlayed = FXCollections.observableArrayList(
    ...
    public void addRecentlyPlayedSong(PlayListWidget recentlyPlayedSong) {
        ...
        recentlyPlayed.addListener(new ListChangeListener<PlayListWidget>() {
            @Override
        ...
        Platform.runLater(()->{
           recentlyPlayed.add(0, recentlyPlayedSong); 
        });   
    }

    public static ScrollPane getRecentlyPlayedList(){
        
        listView = new ListView<>(recentlyPlayed);
